                  ...
                  <CardTitle className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="mt-2 text-sm font-normal">
                        Thông tin sẽ được hiển thị trên trang Tổng quan, dễ dàng
                        tiếp cận Học viên hơn.
                      </p>
                    </div>
                    <div>
                      <Button variant="destructive">Nhập lại</Button>
                      <Button className="ms-2 bg-primary">Lưu thông tin</Button>
                    </div>
                  </CardTitle>
                </CardHeader>
                <CardContent>
                  ...
                  <div className="mt-4">
                    ...
                    <p className="text-[14px] text-[#4b5563]">
                      Bạn phải nhập ít nhất 1 câu hỏi và câu trả lời, tối đa 10
                      cặp FAQ.
                    </p>
                    <div>
                      {faqs.map((qa, index) => (
