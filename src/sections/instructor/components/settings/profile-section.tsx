  ...
  return (
    <div className="min-h-screen bg-slate-50/50">
      <div className="relative">
        <div className="absolute inset-0 h-[300px] bg-gradient-to-br from-orange-500 to-yellow-400">
        ...
        <div className="mx-auto max-w-4xl px-4 pb-12 pt-24 sm:px-6 lg:px-8">
          <Card className="overflow-visible border-none bg-white/95 shadow-xl backdrop-blur-sm">
            <CardHeader className="relative -mt-16 flex flex-col items-center pb-0">
              <div className="relative mb-4">
                ...
                {isEditing && (
                  <Button
                    ...
                    size="icon"
                    variant="secondary"
                    className="absolute -bottom-2 -right-2 size-8 rounded-full bg-orange-500 text-white shadow-lg transition-all hover:bg-orange-600 hover:shadow-orange-500/25"
