      ...
      <div className="flex flex-col justify-between gap-4 rounded-lg bg-gradient-to-r from-orange-50 to-orange-100 p-4 shadow-md sm:flex-row sm:items-center sm:p-6">
        <div>
          <h2 className="flex items-center gap-2 text-xl font-bold text-gray-800 sm:text-2xl">
            <Briefcase className="size-5 text-orange-500 sm:size-6" />
            Quản lý nghề nghiệp
          </h2>
                      ...
                      >
                        <TableCell className="px-4 py-3">
                          <div className="flex items-center gap-2 sm:gap-3">
                            ...
                            >
                              {career.institution_name.charAt(0).toUpperCase()}
                            </div>
                            <div className="min-w-0">
                              ...
                              <div className="mt-0.5 flex flex-wrap items-center gap-1 text-xs text-gray-600 sm:text-sm">
                                ...
                                <span className="truncate">{career.major}</span>
                              </div>
                            </div>
                          </div>
                        </TableCell>
                            ...
                            <AlertDialog>
                              ...
                              <AlertDialogContent className="max-w-[400px] bg-white">
                                <AlertDialogHeader>
                                  ...
                                  <AlertDialogDescription>
                                    Hành động này không thể hoàn tác. Thông tin
                                    nghề nghiệp này sẽ bị xóa vĩnh viễn.
                                  </AlertDialogDescription>
                                </AlertDialogHeader>
                                <AlertDialogFooter>
                        ...
                        {searchQuery ? (
                          ...
                          <div className="flex flex-col items-center justify-center py-12">
                            ...
                            <p className="mt-1 max-w-[300px] text-center text-xs text-gray-500">
                              Thêm thông tin về kinh nghiệm làm việc của bạn để
                    ...
                    <CardContent className="px-5 pb-2">
                      ...
                      <div className="mb-3 flex items-center gap-2 text-xs text-gray-600">
                        ...
                        <span className="whitespace-nowrap font-medium">
                          {career.start_date && career.end_date && (
                            <>
                              {format(new Date(career.start_date), 'MM/yyyy', {
                                locale: vi,
                              })}{' '}
                              -{' '}
                              {format(new Date(career.end_date), 'MM/yyyy', {
                                locale: vi,
                              })}
                            </>
                          )}
