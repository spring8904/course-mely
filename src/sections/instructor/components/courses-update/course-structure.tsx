      ...
      <div className="mt-4 max-w-[800px]">
        ...
        <div className="mt-8">
          ...
          <p className="mt-2 text-sm font-normal">
            ...
            xác định nội dung nào cần đưa vào khóa học và cách bạn sẽ giảng dạy
            nội dung đó để giúp người học đạt được mục tiêu.
          </p>
        </div>
        <div className="mt-8">
        ...
        <div className="mt-8">
          <h4 className="font-bold">
            Bài giảng tập chung vào kiến thức liên quan .
          </h4>
          <p className="mt-2 text-sm font-normal">
            Độ dài bài giảng tốt là 2-7 phút để giữ cho sinh viên hứng thú và
            giúp họ học trong thời gian ngắn. Bao gồm một chủ đề duy nhất trong
            mỗi bài giảng để người học có thể dễ dàng tìm và xem lại sau.
          </p>
        </div>
        <div className="mt-8">
          <h4 className="font-bold">
